...
class AbdominalesEjerc1Activity : AppCompatActivity() {

    private lateinit var binding: ActivityAbdominalesEjerc1Binding
    private lateinit var countDownTimer: CountDownTimer
    private var isTimerRunning = false
    private var timeRemaining: Long = 20000 // 20 segundos
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAbdominalesEjerc1Binding.inflate(layoutInflater)
