...
class BrazosEjerc5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityBrazosEjerc5Binding
    private lateinit var countDownTimer: CountDownTimer
    private var isTimerRunning = false
    private var timeRemaining: Long = 30000 // 30 segundos
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBrazosEjerc5Binding.inflate(layoutInflater)
