...
class BrazosEjerc1Activity : AppCompatActivity() {

    private lateinit var binding: ActivityBrazosEjerc1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBrazosEjerc1Binding.inflate(layoutInflater)
