...
class BrazosEjerc4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityBrazosEjerc4Binding
    private lateinit var countDownTimer: CountDownTimer
    private var isTimerRunning = false
    private var timeRemaining: Long = 30000 // 30 segundos
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBrazosEjerc4Binding.inflate(layoutInflater)
