...
class BrazosEjerc3Activity : AppCompatActivity() {
    private lateinit var binding: ActivityBrazosEjerc3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBrazosEjerc3Binding.inflate(layoutInflater)
